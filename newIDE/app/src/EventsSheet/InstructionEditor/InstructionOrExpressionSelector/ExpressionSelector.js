...
export default class ExpressionSelector extends Component<Props, {||}> {
  instructionsInfo: Array<InstructionOrExpressionInformation> = enumerateExpressions(this.props.expressionType).allExpressions;
  instructionsInfoTree: InstructionOrExpressionTreeNode = createTree(this.instructionsInfo);
